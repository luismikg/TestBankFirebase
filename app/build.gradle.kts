...
android {
    namespace = "com.luis.storibanck"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.luis.storibanck"
        minSdk = 24
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    //Loading
    val loadingVersion = "1.0.0"
    implementation("com.github.Marvel999:Android-Loading-Animation:$loadingVersion")

    //firebase database
    val firebaseDatabaseVersion = "20.3.0"
